...
<link rel="stylesheet" href="AddbuttonStyle.css" />
<!-- moi -->
...
<script type="text/javascript">
                         ...
                         var porto_init_yith_search = function () {
                              (function ($) {
                                   ...
                                   var yith_search = $(
                                        ...
                                        minChars: 3,
                                        appendTo:
                                             ".yith-ajaxsearchform-container1667185076",
                                        serviceUrl: function () {
                                             var val = $(
                                        ...
                                        formatResult: function (
                                             ...
                                             if (
                                                  typeof suggestion.div_badge_open !==
                                                  "undefined"
                                             ) {
                                                  html +=
                                                       suggestion.div_badge_open;
                                             }

                                             if (
                                                  typeof suggestion.on_sale !==
                                                  "undefined"
                                             ) {
                                             ...
                                             if (
                                                  typeof suggestion.div_badge_close !==
                                                  "undefined"
                                             ) {
                                                  html +=
                                                       suggestion.div_badge_close;
                                             }

                                             if (
                                                  typeof suggestion.price !==
                                                       "undefined" &&
                                                  suggestion.price != ""
                                             ) {
                                                  html +=
          ...
          <link
               href="https://fonts.googleapis.com/css?family=Roboto:400%2C700%2C500&amp;display=swap"
               rel="stylesheet"
               property="stylesheet"
               media="all"
               type="text/css"
          ...
          <link
               ...
               href="wp-content/plugins/revslider/public/assets/css/rs6ca88.css?ver=6.5.24"
               media="all"
          />
          <script
          ...
          ></script>
          <script
               src="wp-content/plugins/woocommerce/assets/js/selectWoo/selectWoo.full.minf988.js?ver=1.0.9-wc.7.0.0"
               id="selectWoo-js"
          ></script>
          ...
          <script
               src="wp-content/plugins/yith-woocommerce-ajax-navigation/assets/js/yith-wcan-shortcodes.minf77d.js?ver=4.15.0"
               id="yith-wcan-shortcodes-js"
          ></script>
          ...
          <script id="jquery-yith-wcwl-js-extra">
               var yith_wcwl_l10n = {
                    ...
                    enable_ajax_loading: "",
                    ajax_loader_url:
                         "https:\/\/www.holzelektro.com\/wp-content\/plugins\/yith-woocommerce-wishlist\/assets\/images\/ajax-loader-alt.svg",
          ...
          <script
               src="wp-content/plugins/yith-woocommerce-wishlist/assets/js/jquery.yith-wcwl.mindf38.js?ver=3.14.0"
               id="jquery-yith-wcwl-js"
          ></script>
          <script
               src="wp-content/plugins/contact-form-7/includes/swv/js/index77e1.js?ver=5.6.4"
               id="swv-js"
          ></script>
          ...
          <script
               src="wp-content/plugins/contact-form-7/includes/js/index77e1.js?ver=5.6.4"
               id="contact-form-7-js"
          ></script>
          <script
               src="wp-content/plugins/revslider/public/assets/js/rbtools.min8331.js?ver=6.5.18"
               defer
               async
               id="tp-tools-js"
          ></script>
          <script
               src="wp-content/plugins/revslider/public/assets/js/rs6.minca88.js?ver=6.5.24"
               defer
               async
               id="revmin-js"
          ></script>
          <script
               src="wp-content/plugins/woocommerce/assets/js/js-cookie/js.cookie.minc599.js?ver=2.1.4-wc.7.0.0"
               id="js-cookie-js"
          ></script>
          ...
          <script
               src="wp-content/plugins/woocommerce/assets/js/frontend/woocommerce.min823d.js?ver=7.0.0"
               id="woocommerce-js"
          ></script>
          <script id="wc-cart-fragments-js-extra">
               var wc_cart_fragments_params = {
                    ...
                    wc_ajax_url: "\/?wc-ajax=%%endpoint%%",
                    cart_hash_key:
                         "wc_cart_hash_4861cced293e7c3227214d7186af23c5",
                    fragment_name:
                         "wc_fragments_4861cced293e7c3227214d7186af23c5",
                    request_timeout: "5000",
               };
          </script>
          <script
               src="wp-content/plugins/woocommerce/assets/js/frontend/cart-fragments.min823d.js?ver=7.0.0"
          ...
          <script
               src="wp-content/plugins/yith-woocommerce-compare/assets/js/woocompare.min2d61.js?ver=2.19.0"
               id="yith-woocompare-main-js"
          ></script>
          <script
               src="wp-content/plugins/yith-woocommerce-compare/assets/js/jquery.colorbox-min13ac.js?ver=1.4.21"
               id="jquery-colorbox-js"
          ></script>
          <script id="porto-live-search-js-extra">
               var porto_live_search = { nonce: "cc632048e8" };
          </script>
          <script
               src="wp-content/themes/porto/inc/lib/live-search/live-search.min5c45.js?ver=6.3.3"
               id="porto-live-search-js"
          ></script>
          <script
               src="wp-content/plugins/wc-frontend-manager/includes/libs/jquery-blockui/jquery.blockUI.min0660.js?ver=6.6.5"
               id="jquery-blockui_js-js"
          ></script>
          <script
          ...
          <script
               src="wp-includes/js/jquery/ui/datepicker.min0028.js?ver=1.13.1"
          ...
          <script id="wcfm_core_js-js-extra">
               ...
               var wcfm_core_dashboard_messages = {
                    ...
                    sell_this_item_confirm:
                         "Do you want to add this item(s) to your store?",
               ...
               var wcfmu_products_manage_messages = {
                    ...
                    no_excerpt:
                         "Please insert Product Short Description before submit.",
                    no_description:
                         "Please insert Product Description before submit.",
                    sku_unique: "Produktnummer muss einmalig sein.",
                    variation_sku_unique:
                         "Varianten Produktnummer muss einmalig sein.",
          ...
          <script
               src="wp-content/plugins/wc-frontend-manager/assets/js/min/wcfm-script-core0660.js?ver=6.6.5"
               id="wcfm_core_js-js"
          ></script>
          <script
               src="wp-content/plugins/yith-woocommerce-ajax-search/assets/js/yith-autocomplete.minc862.js?ver=1.24.0"
               id="yith_autocomplete-js"
          ></script>
          <script
               src="wp-content/plugins/pwa-for-wp/assets/js/pwaforwp-video231a.js?ver=1.7.50"
               id="pwaforwp-video-js-js"
          ></script>
          <script
               src="wp-content/plugins/pwa-for-wp/assets/js/pwaforwp-download231a.js?ver=1.7.50"
          ...
          <script
               src="wp-content/plugins/js_composer/assets/js/dist/js_composer_front.mine1b2.js?ver=6.9.0"
               id="wpb_composer_front_js-js"
          ></script>
          <script
               src="wp-content/themes/porto/js/bootstrap972f.js?ver=5.0.1"
               id="bootstrap-js"
          ></script>
          <script
               src="wp-content/plugins/woocommerce/assets/js/jquery-cookie/jquery.cookie.min2e15.js?ver=1.4.1-wc.7.0.0"
               id="jquery-cookie-js"
          ></script>
          <script
               src="wp-content/themes/porto/js/libs/owl.carousel.min531b.js?ver=2.3.4"
               id="owl.carousel-js"
          ></script>
          <script
          ...
          ></script>
          <script
               src="wp-content/themes/porto/js/libs/jquery.selectric.min055b.js?ver=1.9.6"
               id="jquery-selectric-js"
          ></script>
          <script id="porto-theme-js-extra">
               var js_porto_vars = {
                    rtl: "",
                    theme_url:
                         "https:\/\/www.holzelektro.com\/wp-content\/themes\/porto",
                    ajax_url:
                         "https:\/\/www.holzelektro.com\/wp-admin\/admin-ajax.php",
                    change_logo: "",
                    ...
                    compare_popup: "1",
                    compare_popup_title:
                         "Sie f\u00fcgen einfach eine Vergleichsliste hinzu.",
                    prdctfltr_ajax: "",
                    slider_loop: "1",
                    slider_autoplay: "1",
                    slider_autoheight: "1",
          ...
          <script
               src="wp-content/themes/porto/js/theme5c45.js?ver=6.3.3"
               id="porto-theme-js"
          ></script>
          <script
               async="async"
               src="wp-content/themes/porto/js/theme-async5c45.js?ver=6.3.3"
               id="porto-theme-async-js"
          ></script>
          <script
               src="wp-content/themes/porto/js/woocommerce-theme5c45.js?ver=6.3.3"
          ...
          <script
               src="wp-includes/js/wp-util.min1eb7.js?ver=6.0.3"
               id="wp-util-js"
          ></script>
          ...
          <script
               src="wp-content/plugins/woocommerce/assets/js/frontend/add-to-cart-variation.min823d.js?ver=7.0.0"
